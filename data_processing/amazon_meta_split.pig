...
%DEFAULT input_file '/user/recsys/rank_dev/yunjiang.jiang/amazon_data/All_Amazon_Meta.json.gz'

%DEFAULT output_file '/user/recsys/rank_dev/yunjiang.jiang/amazon_data_sharded/All_Amazon_Meta.json'
