...
%DEFAULT input_file '/user/recsys/rank_dev/yunjiang.jiang/amazon_data_sharded/All_Amazon_Review.json/par*.gz'

%DEFAULT output_file '/user/recsys/rank_dev/yunjiang.jiang/amazon_data_processed/All_Amazon_Review.tsv'
